...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        _setEvent: function () {
            ...
            $("nav a, .work_list a").on("click", function(e){
                if(!_buffer) {
                    _buffer = setTimeout(function(){
                        base._checkVisibleElements( e );
                        _buffer = null;
        ...
        _isVisible: function(item) {
            var docViewTop      = $window.scrollTop() + item.options.offset,
                ...
                isActive        = item.element.hasClass("active")
            ;

            return ((isActive) && (elemBottom >= docViewTop) &&  (elemTop <= docViewBottom) &&  (elemBottom <= docViewBottom) &&  (elemTop >= docViewTop));
        },
